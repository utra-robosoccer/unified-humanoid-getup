...
def enjoy3() -> None:  # noqa: C901
    ...
    parser.add_argument(
        "--env", help="environment ID", type=EnvironmentName, default="unified-humanoid-get-up-env-standup-v0"
    )
    parser.add_argument("-f", "--folder", help="Log folder", type=str, default="logs/")
    parser.add_argument(
        "--algo", help="RL Algorithm", default="crossq", type=str, required=False, choices=list(ALGOS.keys())
    )
